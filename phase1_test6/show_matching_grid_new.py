...
for i in range(0,218):
    ...
    df3['hundred']                  = (hundred + [0] * 500)[:500]
    df3['nintyFive_to_hundred']     = (nintyFive_to_hundred + [0] * 500)[:500]
    df3['ninty_to_nintyFive']       = (ninty_to_nintyFive + [0] * 500)[:500]
    df3['eightyFive_to_ninty']      = (eightyFive_to_ninty + [0] * 500)[:500]
    df3['eighty_to_eightyFive']     = (eighty_to_eightyFive + [0] * 500)[:500]
    df3['fifty_to_eighty']          = (fifty_to_eighty + [0] * 500)[:500]
    df3['less_than_fifty']          = (less_than_fifty + [0] * 500)[:500]
    ...
    df3.to_excel(writer, sheet_name=str(i), startrow=700)
    writer.save()
    writer.close()
